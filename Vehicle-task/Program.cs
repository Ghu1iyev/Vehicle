                ...
                switch (Enter2)
                {
                    ...
                    case 2:
                        for (int i = 0; i < carList.CarArr.Length; i++)
                        {
                            ...
                            Console.WriteLine($"Car fuel capacity: {carList.CarArr[i].FuelCapacity}, Car current fuel: {carList.CarArr[i].CurrentFuel}, Car fuel for 1km: {carList.CarArr[i].Brand}.");
